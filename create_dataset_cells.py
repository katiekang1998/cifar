...
ham10000_data_path = "/home/katie/Desktop/pytorch_resnet_cifar10/data/ham10000/"
...
img_ids_train.remove("ISIC_0033739")
...
with open("/home/katie/Desktop/pytorch_resnet_cifar10/data/SkinLesionPixels/labels_train.pkl", "wb") as file:
    pickle.dump(labels_train, file)
with open("/home/katie/Desktop/pytorch_resnet_cifar10/data/SkinLesionPixels/images_train.pkl", "wb") as file:
...
#     except:
#         print(ham10000_data_path + img_id + ".jpg")
# labels_val = np.array(labels_val).astype(np.float32)
# with open("/home/katie/Desktop/pytorch_resnet_cifar10/data/SkinLesionPixels/labels_val.pkl", "wb") as file:
#     pickle.dump(labels_val, file)
# with open("/home/katie/Desktop/pytorch_resnet_cifar10/data/SkinLesionPixels/images_val.pkl", "wb") as file:
...
# with open("/home/katie/Desktop/pytorch_resnet_cifar10/data/SkinLesionPixels/labels_test.pkl", "wb") as file:
#     pickle.dump(labels_test, file)
# with open("/home/katie/Desktop/pytorch_resnet_cifar10/data/SkinLesionPixels/images_test.pkl", "wb") as file:
